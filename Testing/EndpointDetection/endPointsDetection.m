function endPointsDetection(fpath,fRaw,fSeg,sigma)
...
fpath='C:\Users\pankaj singh\Desktop\Read\MatlabExp\TaraKeck\Stack1\Common\Log_Common\Check\';
fRaw='Log_Common_16';
...
WriteRAWandMHD(M,strcat(fRaw,'_detectedEndPoints'),fpath);
