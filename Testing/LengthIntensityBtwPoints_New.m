...
filepath='C:\Users\pankaj singh\Desktop\Read\MatlabExp\TaraKeck\Stack1\E6_R1_T1_Stack1\';
fSeg='Tara_Stack1_E6_R1_T1_Log_E2_sigma_2_Segmentation_SPINES_s_2_t_0_5_b_500';
fEnd='Tara_Stack1_E6_R1_T1_Log_detectedEndPoints';
...
radius=12; % the radius of the neighbourhood of each point(voxel) to be considered
...
WriteRAWandMHD(S,strcat(fEnd,'_Line'),filepath);
